<html><head>
  ...
  <script type="text/javascript">
    ...
    function onopen()
    {
        ...
        // 登录
//      var login_data = '{"type":"login","unme":"'+name.replace(/"/g, '\\"')+'","uid":"<?php echo isset($_GET['uid']) ? $_GET['uid'] : 1?>"}';
        var login_data = '{"type":"login","uid":"159"},"unme":"ms.jiang","pwd":"123456"}';
        ws.send(login_data);
    ...
    function onmessage(e)
    {
        ...
        switch(data['type']){
            ...
            // 登录 更新用户列表
            case 'login':
                //{"type":"login","client_id":xxx,"unme":"xxx","client_list":"[...]","time":"xxx"}
                say(data['client_id'], data['unme'],  data['unme']+' 加入了聊天室', data['time']);
                if(data['client_list'])
                {
                ...
                {
                    client_list[data['client_id']] = data['unme']; 
                }
                flush_client_list();
                console.log(data['unme']+"登录成功");
                break;
            // 发言
            case 'say':
    ...
    <div class="container">
	    <div class="row clearfix">
	        ...
	        <div class="col-md-6 column">
               ...
               <div>
               &nbsp;&nbsp;&nbsp;&nbsp;<b>房间列表:</b>（当前在&nbsp;房间<?php echo isset($_GET['uid'])&&intval($_GET['uid'])>0 ? intval($_GET['uid']):1; ?>）<br>
               &nbsp;&nbsp;&nbsp;&nbsp;<a href="/?uid=1">房间1</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/?uid=2">房间2</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/?uid=3">房间3</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/?uid=4">房间4</a>
               <br><br>
               </div>
